       ...
       <div style="margin: 80px auto 70px; width:360px;">
         ...
         <form name="loginForm" method="post" action="">
           ...
           <tr align="center" height="60"> 
               <td> 
                   <label for="mem_id" id="lblUserId" class="lbl" >아이디</label>
           ...
           <tr align="center" height="60"> 
               <td>
                 <label for="mem_pw" id="lblUserPwd" class="lbl" >패스워드</label>
                 <input type="password" name="mem_pw" id="mem_pw" class="loginTF" maxlength="20" 
                            tabindex="2"
           ...
           <tr align="center" height="40" >
                <td><span style="color: #1993A8;">${message}</span></td>
           </tr>
